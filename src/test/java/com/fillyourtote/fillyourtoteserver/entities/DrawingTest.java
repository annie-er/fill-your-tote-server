...
class DrawingTest {
    ...
    @Test
    void validDrawing() {
        Drawing drawing = new Drawing("Sunset", "A beautiful sunset drawing", "http://example.com/sunset.png");
    ...
    void equalsAndHashCode() {
        Drawing d1 = new Drawing("Tree", "Green tree", "http://example.com/tree.png");
        Drawing d2 = new Drawing("Tree", "Green tree", "http://example.com/tree.png");
    ...
    void toStringContainsFields() {
        Drawing drawing = new Drawing("Flower", "Red rose", "http://example.com/rose.png");
        drawing.setId(5L);
